<?php
	...
	Class Conexao
	{
		...
		public function selectClientes($dados){
			...
			try
			{
				$mostra = $this->pdo->prepare("SELECT tbl_clientes.id_cliente,tbl_clientes.nome,tbl_clientes.idade,tbl_clientes.telefone,tbl_clientes.endereco,tbl_clientes.id_categoria,tbl_categoria.nome as 'cat_nome' FROM tbl_clientes LEFT JOIN tbl_categoria ON tbl_clientes.id_categoria = tbl_categoria.id_categoria WHERE tbl_clientes.nome like '%{$dados}%'");
